...
#define PREFIX  "libfileio_scdc_srv: "

#define LIBFILEIO_SCDC_SRV_BASE  "store"
#define LIBFILEIO_SCDC_SRV_PATH  "store"
...
int main(int argc, char *argv[])
{
  ...
  scdc_dataprov_t dp = scdc_dataprov_open(LIBFILEIO_SCDC_SRV_BASE, "fs:access", LIBFILEIO_SCDC_SRV_PATH);

  printf(PREFIX "nodeport open\n");
/*  scdc_nodeport_t np = scdc_nodeport_open("uds:socketname:max_connections", "libfileio_scdc", 2);*/
