...
#ifndef __FSTREAM_SCDC_HH__
#define __FSTREAM_SCDC_HH__

#pragma GCC system_header

#define USE_FSTREAM_SCDC_LOGGER  0
#define USE_FSTREAM_SCDC         1
...
#if USE_FSTREAM_SCDC_LOGGER
# include "fstream_scdc_logger.hh"
# define TRACE(_f_, _x_...)  fstream_scdc_logger::TRACE(_f_, _x_)
# define ERROR(_f_, _x_...)  fstream_scdc_logger::ERROR(_f_, _x_)
#else /* USE_FSTREAM_SCDC_LOGGER */
# define TRACE(_f_, _x_...)  do { } while (0)
# define ERROR(_f_, _x_...)  do { } while (0)
#endif /* USE_FSTREAM_SCDC_LOGGER */

#if USE_FSTREAM_SCDC
# include "basic_file_scdc.h"
#endif /* USE_FSTREAM_SCDC */

#define CONCAT(_a_, _b_)  CONCAT_(_a_, _b_)
#define CONCAT_(_a_, _b_)  _a_ ## _b_

#ifdef FSTREAM_SCDC_SUFFIX
# define basic_filebuf   CONCAT(basic_filebuf, FSTREAM_SCDC_SUFFIX)
# define basic_ifstream  CONCAT(basic_ifstream, FSTREAM_SCDC_SUFFIX)
# define basic_ofstream  CONCAT(basic_ofstream, FSTREAM_SCDC_SUFFIX)
# define basic_fstream   CONCAT(basic_fstream, FSTREAM_SCDC_SUFFIX)
# define filebuf         CONCAT(filebuf, FSTREAM_SCDC_SUFFIX)
# define ifstream        CONCAT(ifstream, FSTREAM_SCDC_SUFFIX)
# define ofstream        CONCAT(ofstream, FSTREAM_SCDC_SUFFIX)
# define fstream         CONCAT(fstream, FSTREAM_SCDC_SUFFIX)
# define wfilebuf        CONCAT(wfilebuf, FSTREAM_SCDC_SUFFIX)
# define wifstream       CONCAT(wifstream, FSTREAM_SCDC_SUFFIX)
# define wofstream       CONCAT(wofstream, FSTREAM_SCDC_SUFFIX)
# define wfstream        CONCAT(wfstream, FSTREAM_SCDC_SUFFIX)
#endif /* FSTREAM_SCDC_SUFFIX */
...
#if USE_FSTREAM_SCDC
      typedef __basic_file_scdc<char> __file_type_scdc;
#endif /* USE_FSTREAM_SCDC */
...
#if USE_FSTREAM_SCDC
      bool _M_file_type_scdc;
      __file_type_scdc _M_file_scdc;
#endif /* USE_FSTREAM_SCDC */
