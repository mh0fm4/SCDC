...
{
  TRACE_F("%s: rc: %p, id: '%s', a: %p, n: %" rdint_fmt, __func__, rc, id, a, n);
  ...
  redirect_call_put_input_param_dense(rc, id, a, n * sizeof(T));
}
...
void redirect_call_get_input_param_array_val(redirect_call_t *rc, const char *id, T **a, rdint_t *n)
{
  ...
  redirect_call_get_input_param_dense(rc, id, reinterpret_cast<void **>(a), *n * sizeof(T));
...
void redirect_call_put_output_param_array_val(redirect_call_t *rc, const char *id, const T *a, rdint_t n)
{
  ...
  if (rc->client) redirect_call_put_input_conf_rdint(rc, "a", n);
  else redirect_call_put_output_conf_rdint(rc, "a", n);
  redirect_call_put_output_param_dense(rc, id, a, n * sizeof(T));
}
...
void redirect_call_get_output_param_array_val(redirect_call_t *rc, const char *id, T **a, rdint_t *n)
{
  ...
  if (rc->client) redirect_call_get_output_conf_rdint(rc, "a", n);
  else redirect_call_get_input_conf_rdint(rc, "a", n);
  redirect_call_get_output_param_dense(rc, id, reinterpret_cast<void **>(a), *n * sizeof(T));
...
void redirect_call_put_inout_param_array_val(redirect_call_t *rc, const char *id, const T *a, rdint_t n)
{
  ...
  redirect_call_put_inout_param_dense(rc, id, a, n * sizeof(T));
}
...
void redirect_call_get_inout_param_array_val(redirect_call_t *rc, const char *id, T **a, rdint_t *n)
{
  ...
  redirect_call_get_inout_param_dense(rc, id, reinterpret_cast<void **>(a), *n * sizeof(T));
