...
#ifndef __LIBBLAS_SCDC_CONFIG_H__
#define __LIBBLAS_SCDC_CONFIG_H__
...
#elif 1
# define LIBBLAS_SCDC_URI_DEFAULT  "scdc+tcp://localhost/blas"
#endif

#define LIBBLAS_SCDC_TRACE_DATA  1

#define LIBBLAS_SCDC_CACHE  (REDIRECT_CALL_PARAMS_CACHE && 1)
...
#endif /* __LIBBLAS_SCDC_CONFIG_H__ */
