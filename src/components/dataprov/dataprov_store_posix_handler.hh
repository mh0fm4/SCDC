...
#ifndef __DATAPROV_STORE_POSIX_HANDLER_HH__
#define __DATAPROV_STORE_POSIX_HANDLER_HH__
...
class scdc_dataprov_store_posix_handler: public scdc_dataprov_access_posix_handler<POSIX_HANDLER>
{
  public:
    typedef typename scdc_dataprov_access_posix_handler<POSIX_HANDLER>::dir_t store_t;
    static const store_t store_null;

    typedef typename scdc_dataprov_access_posix_handler<POSIX_HANDLER>::file_t entry_t;
    ...
    static const bool HAVE_entry_read_access_at = scdc_dataprov_access_posix_handler<POSIX_HANDLER>::HAVE_file_read_access_at;
...
#endif /* __DATAPROV_STORE_POSIX_HANDLER_HH__ */
