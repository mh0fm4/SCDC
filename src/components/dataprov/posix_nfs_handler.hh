...
#ifndef __POSIX_NFS_HANDLER_HH__
#define __POSIX_NFS_HANDLER_HH__
...
class scdc_posix_nfs_handler
{
  public:
    static const char * const type;

    typedef struct nfsdir *dir_t;
    static const dir_t dir_null;

    typedef struct nfsfh *file_t;
  ...
  private:
    ...
    bool dir_rm_r(const char *path);
};


#endif /* __POSIX_NFS_HANDLER_HH__ */
