...
scdcint_t input_next(scdc_dataset_input_t *input, scdc_result_t *result)
{
...
scdcint_t output_next(scdc_dataset_output_t *output, scdc_result_t *result)
{
