...
# define TRACE(...)      Z_MOP(TRACE_FPRINTF(TRACE_FILE, TRACE_PREFIX __VA_ARGS__); TRACE_FPRINTF(TRACE_FILE, "\n");)
# define TRACE_N(...)    Z_MOP(TRACE_FPRINTF(TRACE_FILE, TRACE_PREFIX __VA_ARGS__);)
# define TRACE_F(...)    Z_MOP(TRACE_FPRINTF(TRACE_FILE, TRACE_PREFIX "%s: ", __func__); TRACE_FPRINTF(TRACE_FILE, __VA_ARGS__); TRACE_FPRINTF(TRACE_FILE, "\n");)
# define TRACE_F_N(...)  Z_MOP(TRACE_FPRINTF(TRACE_FILE, TRACE_PREFIX "%s: ", __func__); TRACE_FPRINTF(TRACE_FILE, __VA_ARGS__);)
# define TRACE_R(...)    Z_MOP(TRACE_FPRINTF(TRACE_FILE, __VA_ARGS__);)
#else
# define TRACE_CMD(_c_)  Z_NOP()
# define TRACE(...)      Z_NOP()
# define TRACE_N(...)    Z_NOP()
# define TRACE_F(...)    Z_NOP()
# define TRACE_F_N(...)  Z_NOP()
# define TRACE_R(...)    Z_NOP()
#endif
